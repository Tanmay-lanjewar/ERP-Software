...
export default function AddItems() {
  ...
  useEffect(() => {
    axios
      .get("http://72.62.227.63:5001/api/taxes")
      .then((res) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
    await axios.post("http://72.62.227.63:5001/api/products", dataToSend);
      navigate("/item-list");
    } catch (error) {
  ...
  const handleAddUnit = async () => {
    ...
    await axios.post("http://72.62.227.63:5001/api/product_units", {
